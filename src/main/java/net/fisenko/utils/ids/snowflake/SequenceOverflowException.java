...
public class SequenceOverflowException extends Exception {
    ...
    /**
     * Initializes a new instance of the {@link SequenceOverflowException} class with a message that describes
     * the error and underlying exception.
     * @param message        The message that describes the exception. The caller of this constructor is required to ensure that this
     *                       string has been localized for the current system culture.
     * @param innerException The exception that is the cause of the current {@link SequenceOverflowException}. If the
