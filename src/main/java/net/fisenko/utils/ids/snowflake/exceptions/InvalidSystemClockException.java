...
public class InvalidSystemClockException extends Exception {
    ...
    /**
     * Initializes a new instance of the {@link InvalidSystemClockException} class with a message that describes the error and underlying exception.
     *
     ...
     *                       system culture.
     * @param innerException The exception that is the cause of the current {@link InvalidSystemClockException}. If the innerException parameter is not null, the current exception
